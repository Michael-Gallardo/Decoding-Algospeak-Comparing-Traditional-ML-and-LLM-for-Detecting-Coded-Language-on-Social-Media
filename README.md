...
Baseline classification using traditional ML models
Prompt-based and transformer-based LLM evaluation
Comparative analysis of model performance
# Repository Structure
data/ manual_reddit_comments.csv synthetic_augmented.csv notebooks/ 01_preprocessing_and_baseline_ml.ipynb 02_llm_evaluation.ipynb README.md requirements.txt
